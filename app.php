...
if (isset($_POST["submit"])) {
      ...
      // Check if message has been entered and is valid
      if (!$_POST['message1']) {
...
<head>
  ...
  <meta itemprop="description" content="Οικοσύστημα Καινοτομίας Θεσσαλονίκης">
  <meta itemprop="image" content="img/logo.png">

  <!-- Open Graph data -->
  <meta property="og:title" content="OK!Thess">
  <meta property="og:description" content="Οικοσύστημα Καινοτομίας Θεσσαλονίκης">
...
<div class="container">
  ...
  <br>
  <a class="btn btn-primary" href="http://okthess.gr/pdf/website-open-call.pdf" role="button">Πληροφορίες</a>
  <a class="btn btn-primary" href="http://okthess.gr/under-construction.html" role="button">Eσωτερικός κανονισμός</a>
  <br>
  <br>
  <h2 class="text-muted">Φόρμα Συμμετοχής</h2>
  <p><small>(Η φόρμα δεν λειτουργεί προσωρινά για τεχνικούς λόγους)</small></p>
  ---------------
